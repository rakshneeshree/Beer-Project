...
import guru.springframework.Springrestmvc.services.CustomerService;
...
public class CustomerController {
    ...
    public ResponseEntity updateByPatch(@PathVariable("customerId") UUID customerId, @RequestBody CustomerDTO customer){
    ...
    public CustomerDTO getCustomerById(@PathVariable("customerId")UUID customerId){
        log.debug("Get Customer by ID is in service - in controller");
